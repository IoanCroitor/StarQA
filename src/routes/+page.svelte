...
<nav class="absolute top=0 h-16 w-full flex flex-row items-center">
  <a href="/" class="text-lg font-semibold ml-6">StarQA</a>
</nav>
<article class="flex flex-col justify-center items-center h-screen mx-4 ">
  <h1 class="text-3xl text-center font-semibold"><span class="font-bold">StarQA⭐:</span> Crafting <span class="underline decoration-wavy decoration-purple-300">Stellar</span> Quizzes</h1>
