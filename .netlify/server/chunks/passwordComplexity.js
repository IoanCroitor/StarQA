...
import 'dequal'
import { o as omit, m as makeElement, d as createElHelpers } from './index2.js'
import {
...
const Progress$1 = create_ssr_component(
...
const confirm_password = /* @__NO_SIDE_EFFECTS__ */ (
  params = {},
  options = {},
) => {
  return {
            ...
            [
              {
                class: escape_attribute_value(
                  cn(
                    'relative w-full overflow-hidden rounded-full bg-primary/20 h-full flex-1  transition-all',
                    className,
                  ),
                ),
              },
