...
import {
  ...
  g as getNextFocusable,
  a as getPreviousFocusable,
  b as addHighlight,
  e as generateId,
...
const Menu_sub = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    ...
    const idValues = derived(
      ...
      ([$menuId, $triggerId]) => ({ menu: $menuId, trigger: $triggerId }),
    )
...
const Menu_item = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    let builder
    let attrs
...
const Menu_group = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    let builder
...
const Menu_label = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    let builder
    let $$restProps = compute_rest_props($$props, ['asChild', 'el'])
...
const Menu_content = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    let builder
    let $$restProps = compute_rest_props($$props, [
      'transition',
...
const Menu_trigger = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    let builder
...
const Dropdown_menu_item = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
...
const Dropdown_menu_label = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    let $$restProps = compute_rest_props($$props, ['class', 'inset'])
    let { class: className = void 0 } = $$props
    let { inset = void 0 } = $$props
...
const Dropdown_menu_content = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    let $$restProps = compute_rest_props($$props, [
      'class',
      'sideOffset',
