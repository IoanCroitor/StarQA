import { c as create_ssr_component, s as spread, d as escape_object, a as add_attribute, v as validate_component, b as escape_attribute_value, e as escape, f as each } from "../../../chunks/ssr.js";
import { g as getTranslationFunctions } from "../../../chunks/index2.js";
import "../../../chunks/index4.js";
import { o as omit, w as withGet, m as makeElement, g as executeCallbacks, a as addMeltEventListener, k as kbd, s as styleToString, u as useEscapeKeydown, e as effect, p as portalAttr, c as createElHelpers, f as isHTMLElement, n as noop, i as isBrowser } from "../../../chunks/index3.js";
import "dequal";
import { e as setContext, g as getContext, s as subscribe, c as compute_rest_props } from "../../../chunks/lifecycle.js";
...
import { g as generateIds, m as useModal, n as createFocusTrap, a as getPortalDestination, b as usePortal, e as removeScroll } from "../../../chunks/helpers.js";
import { h as handleFocus, R as Root$1, T as Trigger$1, D as Dropdown_menu_content, a as Dropdown_menu_label, b as Dropdown_menu_item } from "../../../chunks/index6.js";
    ...
    default: () => {
      return `${validate_component(Trigger$1, "DropdownMenu.Trigger").$$render($$result, { asChild: true }, {}, {
        ...
        default: () => {
          ...
          )} ${validate_component(Dropdown_menu_item, "DropdownMenu.Item").$$render($$result, { class: "text-red-500", href: "/logout" }, {}, {
            default: () => {
              return `Logout`;
            }
          })}`;
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  )}</a></nav></div> <div class="p-2">${validate_component(JoinCard, "JoinCard").$$render($$result, {}, {}, {})}</div></div></div> <div class="flex flex-col"><header class="flex h-14 items-center gap-4 border-b bg-muted/40 px-4 lg:h-[60px] lg:px-6">${validate_component(Root, "Sheet.Root").$$render($$result, {}, {}, {
    default: () => {
