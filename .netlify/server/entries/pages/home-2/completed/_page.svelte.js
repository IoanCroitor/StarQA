...
const Card_1 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if (
    $$props.cover_image === void 0 &&
    $$bindings.cover_image &&
    cover_image !== void 0
  )
    $$bindings.cover_image(cover_image)
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${
    $records && $records.length > 0
      ? `<div class="flex items-center" data-svelte-h="svelte-1r7sclb"><h2 class="text-lg font-semibold md:text-2xl">Completed Quizzes</h2></div> <div class="flex flex-1 rounded-lg border border-dashed shadow-sm p-4"><div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 2xl:grid-cols-5 gap-2 w-full h-min">${each(
          $records,
          (quiz) => {
      ...
      : `<div class="flex items-center" data-svelte-h="svelte-pepqq2"><h2 class="text-lg font-semibold md:text-2xl">Searching🔎</h2></div>`
  }`
})
