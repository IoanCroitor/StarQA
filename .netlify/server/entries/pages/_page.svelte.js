...
const tailored_just_for_you$3 = /* @__NO_SIDE_EFFECTS__ */ () =>
  `Tailored Just for You`
const tailored_just_for_you$2 = /* @__NO_SIDE_EFFECTS__ */ () =>
  `Personalizat doar pentru tine`
const tailored_just_for_you$1 = /* @__NO_SIDE_EFFECTS__ */ () =>
  `Conçu juste pour vous`
const tailored_just_for_you = /* @__NO_SIDE_EFFECTS__ */ (
  params = {},
  options = {},
) => {
  return {
...
const crafting_stellar_quizzes$3 = /* @__NO_SIDE_EFFECTS__ */ () =>
  `Crafting Stellar Quizzes`
const crafting_stellar_quizzes$2 = /* @__NO_SIDE_EFFECTS__ */ () =>
  `Creaza chestionare stelare`
const crafting_stellar_quizzes$1 = /* @__NO_SIDE_EFFECTS__ */ () =>
  `Créer des quiz stellaires`
const crafting_stellar_quizzes = /* @__NO_SIDE_EFFECTS__ */ (
  params = {},
  options = {},
) => {
  return {
