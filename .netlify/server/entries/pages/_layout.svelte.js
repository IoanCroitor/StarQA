...
import {
  s as setParaglideContext,
  g as getTranslationFunctions,
...
import {
  ...
  a as toastState,
  u as useEffect,
} from '../../chunks/Toaster.svelte_svelte_type_style_lang.js'
import { d as derived, w as writable } from '../../chunks/index5.js'
function isExternal(url, currentUrl, base2) {
  const absoluteBase = new URL(base2 ?? '/', currentUrl).pathname
  return (
    url.origin !== currentUrl.origin || !url.pathname.startsWith(absoluteBase)
  )
}
const AlternateLinks = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    ...
    if (
      $$props.availableLanguageTags === void 0 &&
      $$bindings.availableLanguageTags &&
      availableLanguageTags !== void 0
    )
      $$bindings.availableLanguageTags(availableLanguageTags)
    if (
    ...
    if (
      $$props.currentLang === void 0 &&
      $$bindings.currentLang &&
      currentLang !== void 0
    )
      $$bindings.currentLang(currentLang)
...
const ParaglideJS = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    let lang
    let $page, $$unsubscribe_page
    $$unsubscribe_page = subscribe(page, (value) => ($page = value))
    ...
    function translateHref(href, hreflang) {
      try {
        ...
        const [localisedCurrentPath, suffix] = parseRoute(
          localisedCurrentUrl.pathname,
          absoluteBase,
        )
        const canonicalCurrentPath = i18n2.strategy.getCanonicalPath(
          localisedCurrentPath,
          lang,
        )
        const canonicalCurrentUrl = new URL(localisedCurrentUrl)
        canonicalCurrentUrl.pathname = serializeRoute(
        ...
        if (
          ...
          i18n2.config.exclude(original_to.pathname)
        )
          return href
        const targetLanguage = hreflang ?? lang
        const [canonicalPath, dataSuffix] = parseRoute(
          original_to.pathname,
          absoluteBase,
        )
        const translatedPath = i18n2.strategy.getLocalisedPath(
          canonicalPath,
          targetLanguage,
        )
    ...
    if (
      $$props.languageTag === void 0 &&
      $$bindings.languageTag &&
      languageTag !== void 0
    )
      $$bindings.languageTag(languageTag)
    if ($$props.i18n === void 0 && $$bindings.i18n && i18n2 !== void 0)
      $$bindings.i18n(i18n2)
    lang = languageTag ?? i18n2.getLanguageFromUrl($page.url)
    $$unsubscribe_page()
    return `  ${
      (($$result.head += `<!-- HEAD_svelte-12suvtl_START -->${
        i18n2.config.seo.noAlternateLinks !== true &&
        !i18n2.config.exclude($page.url.pathname)
          ? `${validate_component(AlternateLinks, 'AlternateLinks').$$render(
              $$result,
              {
                availableLanguageTags:
                  i18n2.config.runtime.availableLanguageTags,
...
const Loader = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="sonner-loading-wrapper"${add_attribute('data-visible', visible, 0)}><div class="sonner-spinner">${each(
    bars,
    (_, i) => {
...
const Toast = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let $$unsubscribe_effect = noop,
    $$subscribe_effect = () => (
      $$unsubscribe_effect(),
      ($$unsubscribe_effect = subscribe(effect, ($$value) => $$value)),
      effect
    )
  ...
  function pauseTimer() {
    if (lastCloseTimerStartTimeRef < closeTimerStartTimeRef) {
      const elapsedTime =
        /* @__PURE__ */ new Date().getTime() - closeTimerStartTimeRef
  ...
  if (
    $$props.visibleToasts === void 0 &&
    $$bindings.visibleToasts &&
    visibleToasts !== void 0
  )
    $$bindings.visibleToasts(visibleToasts)
  if (
    $$props.expandByDefault === void 0 &&
    $$bindings.expandByDefault &&
    expandByDefault !== void 0
  )
    $$bindings.expandByDefault(expandByDefault)
  if (
    $$props.closeButton === void 0 &&
    $$bindings.closeButton &&
    closeButton !== void 0
  )
    $$bindings.closeButton(closeButton)
  if (
    $$props.interacting === void 0 &&
    $$bindings.interacting &&
    interacting !== void 0
  )
    $$bindings.interacting(interacting)
  if (
    $$props.cancelButtonStyle === void 0 &&
    $$bindings.cancelButtonStyle &&
    cancelButtonStyle !== void 0
  )
    $$bindings.cancelButtonStyle(cancelButtonStyle)
  if (
    $$props.actionButtonStyle === void 0 &&
    $$bindings.actionButtonStyle &&
    actionButtonStyle !== void 0
  )
    $$bindings.actionButtonStyle(actionButtonStyle)
  if ($$props.duration === void 0 && $$bindings.duration && duration !== void 0)
    $$bindings.duration(duration)
  if (
    $$props.descriptionClass === void 0 &&
    $$bindings.descriptionClass &&
    descriptionClass !== void 0
  )
  ...
  $$unsubscribe_heights()
  $$unsubscribe_toasts()
  return `   <li${add_attribute('aria-live', toast.important ? 'assertive' : 'polite', 0)} aria-atomic="true" role="status"${add_attribute('tabindex', 0, 0)}${add_attribute('class', cn($$props.class, toastClass, classes?.toast, toast?.classes?.toast, classes?.[toastType], toast?.classes?.[toastType]), 0)} data-sonner-toast=""${add_attribute('data-styled', !(toast.component || toast?.unstyled || unstyled), 0)}${add_attribute('data-mounted', mounted, 0)}${add_attribute('data-promise', Boolean(toast.promise), 0)}${add_attribute('data-removed', removed, 0)}${add_attribute('data-visible', isVisible, 0)}${add_attribute('data-y-position', coords[0], 0)}${add_attribute('data-x-position', coords[1], 0)}${add_attribute('data-index', index, 0)}${add_attribute('data-front', isFront, 0)}${add_attribute('data-swiping', swiping, 0)}${add_attribute('data-type', toastType, 0)}${add_attribute('data-invert', invert, 0)}${add_attribute('data-swipe-out', swipeOut, 0)}${add_attribute('data-expanded', Boolean(expanded || (expandByDefault && mounted)), 0)}${add_styles(
    merge_ssr_styles(escape(`${$$props.style} ${toast.style}`, true), {
      '--index': index,
      '--toasts-before': index,
...
const Toaster = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if (
    ...
    $$bindings.closeButton(closeButton)
  if (
    $$props.toastOptions === void 0 &&
    $$bindings.toastOptions &&
    toastOptions !== void 0
  )
  ...
  return `${
    $toasts.length > 0
      ? `<section${add_attribute('aria-label', `Notifications ${hotkeyLabel}`, 0)}${add_attribute('tabindex', -1, 0)}>${each(
          possiblePositions,
          (position2, index) => {
            return `<ol${spread(
              [
                ...
                {
                  dir: escape_attribute_value(
                    dir === 'auto' ? getDocumentDirection() : dir,
                  ),
                },
                {
                  'data-y-position': escape_attribute_value(
                    position2.split('-')[0],
                  ),
                },
                {
                  'data-x-position': escape_attribute_value(
                    position2.split('-')[1],
                  ),
                },
                {
            ...
            )}${add_attribute('this', listRef, 0)}>${each(
              $toasts.filter(
                (toast) =>
...
const Sonner_1 = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    let $$restProps = compute_rest_props($$props, [])
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.data === void 0 && $$bindings.data && data !== void 0)
    $$bindings.data(data)
  return `${validate_component(ParaglideJS, 'ParaglideJS').$$render(
    $$result,
    { i18n },
    {},
    {
