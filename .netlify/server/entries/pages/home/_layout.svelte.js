...
const Menu_sub_content = create_ssr_component(
...
const Menu_sub_trigger = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    let builder
    let attrs
    let $$restProps = compute_rest_props($$props, [
    ...
    $$unsubscribe_subTrigger = subscribe(
      subTrigger,
      (value) => ($subTrigger = value),
    )
    const { disabled: disabledStore } = options
    $$unsubscribe_disabledStore = subscribe(
      disabledStore,
      (value) => ($disabledStore = value),
    )
    createDispatcher()
    if (
...
const Dropdown_menu_shortcut = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
...
const Dropdown_menu_sub_content = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    let $$restProps = compute_rest_props($$props, [
      'class',
      'transition',
...
const ChevronRight = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    let $$restProps = compute_rest_props($$props, [
      'size',
      'role',
...
const Dropdown_menu_sub_trigger = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<nav class="bg-muted/40 backdrop-blur-lg w-full fixed z-40"><div class="flex gap-4 top-0 h-14 items-center text-slate-200 px-4 justify-between max-w-[100rem] mx-auto"><a class="hover:underline font-semibold decoration-wavy"${add_attribute('href', paraglide_sveltekit_translate_attribute_pass_translateAttribute(`/home`, void 0), 0)}>StarQA</a> <div class="flex flex-row gap-2">${validate_component(
    ...
    $$result,
    { variant: 'ghost', href: '/home/create' },
    {},
    {
      default: () => {
  ...
  )}</div> ${validate_component(Root, 'DropdownMenu.Root').$$render(
    $$result,
    {},
    {},
    {
