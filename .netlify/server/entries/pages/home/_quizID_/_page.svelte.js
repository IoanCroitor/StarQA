...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.data === void 0 && $$bindings.data && data !== void 0)
    $$bindings.data(data)
  $$unsubscribe_page()
  return `${`<div class="py-2">${validate_component(Card, 'Card.Root').$$render(
    $$result,
    {},
    {},
    {
      default: () => {
        return `${validate_component(Card_header, 'Card.Header').$$render(
          ...
          {
            default: () => {
              return `<div class="flex flex-row gap-2 items-center">${validate_component(
                Card_title,
                'Card.Title',
              ).$$render(
                $$result,
