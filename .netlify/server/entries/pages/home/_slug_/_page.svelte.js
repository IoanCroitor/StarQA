import { s as setContext, l as hasContext, g as getContext, c as create_ssr_component, b as compute_rest_props, o as onDestroy, d as spread, f as escape_attribute_value, h as escape_object, a as subscribe, v as validate_component, e as escape, i as add_attribute, n as add_styles, k as each } from "../../../../chunks/ssr.js";
...
const Trivia = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.intrebare === void 0 && $$bindings.intrebare && intrebare !== void 0)
    $$bindings.intrebare(intrebare);
  if ($$props.detalii === void 0 && $$bindings.detalii && detalii !== void 0)
    $$bindings.detalii(detalii);
...
const Quiz = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.precision === void 0 && $$bindings.precision && precision2 !== void 0)
    $$bindings.precision(precision2);
  $$result.css.add(css);
...
const ScorCurent = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let { nrq = 1 } = $$props;
  let procentage = 0;
  if ($$props.nrq === void 0 && $$bindings.nrq && nrq !== void 0)
    $$bindings.nrq(nrq);
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.questionTypeStore === void 0 && $$bindings.questionTypeStore && questionTypeStore !== void 0)
    $$bindings.questionTypeStore(questionTypeStore);
