...
const Skeleton = create_ssr_component(
...
const by_continuing_you_agree_to_the$1 = /* @__NO_SIDE_EFFECTS__ */ () =>
...
const error_fetching_author$1 = /* @__NO_SIDE_EFFECTS__ */ () =>
  `Error fetching author`
const error_loading_image_from$3 = /* @__NO_SIDE_EFFECTS__ */ (params) =>
  `Error loading image from ${params.author}`
const on$3 = /* @__NO_SIDE_EFFECTS__ */ (params) => `on ${params.name}`
const by_continuing_you_agree_to_the = /* @__NO_SIDE_EFFECTS__ */ (
  params = {},
  options = {},
) => {
  return {
...
const terms_of_service = /* @__NO_SIDE_EFFECTS__ */ (
  params = {},
  options = {},
) => {
  return {
...
const privacy_policy = /* @__NO_SIDE_EFFECTS__ */ (
  params = {},
  options = {},
) => {
  return {
...
const error_fetching_author = /* @__NO_SIDE_EFFECTS__ */ (
  params = {},
  options = {},
) => {
  return {
...
const error_loading_image_from$2 = /* @__NO_SIDE_EFFECTS__ */ (params) =>
  `Eroare la încărcarea imaginii de la ${params.author}`
const error_loading_image_from$1 = /* @__NO_SIDE_EFFECTS__ */ (params) =>
  `Erreur de chargement de l'image depuis ${params.author}`
const error_loading_image_from = /* @__NO_SIDE_EFFECTS__ */ (
  params,
  options = {},
) => {
  return {
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.data === void 0 && $$bindings.data && data !== void 0)
    $$bindings.data(data)
  $$unsubscribe_page()
  return `<div class="container relative h-screen flex-col items-center justify-center grid max-w-none lg:grid-cols-2 lg:px-0">${validate_component(
    Button,
    'Button',
  ).$$render(
    $$result,
