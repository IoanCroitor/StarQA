...
const we_have_sent_you_an_email_to_reset_your_password$1 =
  /* @__NO_SIDE_EFFECTS__ */ () =>
    `We have sent you an email with a link to reset your password`
const we_have_sent_you_an_email_to_reset_your_password =
  ...
  formSubmit: async (event) => {
    ...
    if (supabaseError) {
      ...
      return message(form, {
        status: 200,
        message:
          /* @__PURE__ */ we_have_sent_you_an_email_to_reset_your_password(),
      })
    }
  },
}
