...
import {
  ...
  C as Control,
  a as Form_label,
  b as Form_field_errors,
  c as Form_button,
  S as Spinner,
} from '../../../../chunks/index8.js'
...
import {
  s as superForm,
  e as zodClient,
  p as passwordConfirmSchema,
} from '../../../../chunks/zod-schema.js'
import '../../../../chunks/index.js'
import 'devalue'
import 'memoize-weak'
import {
  c as calculateStrength,
  p as progressColorFunction,
  a as confirm_password,
  P as Progress,
} from '../../../../chunks/passwordComplexity.js'
import {
  h as handleToast,
  p as password,
  e as enter_your_password,
} from '../../../../chunks/handleToast.js'
...
const change_password = /* @__NO_SIDE_EFFECTS__ */ (
  params = {},
  options = {},
) => {
  return {
...
const New_password = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    ...
    do {
      ...
      $$rendered = `<div class="grid gap-2"><form method="POST"${add_attribute('action', paraglide_sveltekit_translate_attribute_pass_translateAttribute(`?/formSubmit`, void 0), 0)} class="w-full grid gap-1"> ${validate_component(
        Form_field,
        'Form.Field',
      ).$$render(
        $$result,
        ...
        {
          default: () => {
            return `${validate_component(Control, 'Form.Control').$$render(
              $$result,
              {},
              {},
              {
      ...
      )} <div class="w-full px-1 my-1">${validate_component(
        Progress,
        'Progress',
      ).$$render(
        $$result,
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    $$settled = true
    $$result.head = previous_head
    $$rendered = `${(($$result.head += `<!-- HEAD_svelte-1ygg0t5_START -->${(($$result.title = `<title>${escape(/* @__PURE__ */ new_password())}</title>`), '')}<!-- HEAD_svelte-1ygg0t5_END -->`), '')} ${validate_component(
      New_password,
      'SettingsForm',
    ).$$render(
      $$result,
