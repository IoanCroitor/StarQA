	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/convertMarkdown/_server.ts.js'))
			},
			{
				id: "/auth/callback",
			...
			{
				id: "/home/[quizID]/results",
				pattern: /^\/home\/([^/]+?)\/results\/?$/,
				params: [{"name":"quizID","optional":false,"rest":false,"chained":false}],
