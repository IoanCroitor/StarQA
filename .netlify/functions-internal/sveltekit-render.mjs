        ...
        routes: [
          ...
          },
          {
            ...
            endpoint: __memo(
              () =>
                import(
                  '../server/entries/endpoints/api/convertMarkdown/_server.ts.js'
                ),
            ),
          },
          {
            ...
            endpoint: __memo(
              () =>
                import(
                  '../server/entries/endpoints/auth/callback/_server.ts.js'
                ),
            ),
          },
          {
            ...
            endpoint: __memo(
              () =>
                import(
                  '../server/entries/endpoints/auth/confirm/_server.ts.js'
                ),
            ),
          },
          {
            ...
            endpoint: __memo(
              () =>
                import('../server/entries/endpoints/auth/google/_server.ts.js'),
            ),
          },
          {
            id: '/auth/login',
